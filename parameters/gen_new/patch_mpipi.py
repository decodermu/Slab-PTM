...
def add_eps(workbook,eps_factors,sheet_name="eps"):
    if sheet_name not in workbook.sheetnames:
        raise ValueError(f"Sheet '{sheet_name}' not found.")
    ...
    for i in range(0,20):
        value_tmp = ref_data["S"][i] * eps_factors["Sp"][i]
        sheet.cell(row=i+2,column=22).value = value_tmp
        sheet.cell(row=22,column=i+2).value = value_tmp
    #Sp-Sp, Tp-Sp, Yp-Sp, acK-Sp, Rm-Sp
    sheet.cell(row=22,column=22).value = ref_data["S"][13] * eps_factors["Sp"][20]
    sheet.cell(row=23,column=22).value = ref_data["S"][7] * eps_factors["Sp"][21]
    sheet.cell(row=24,column=22).value = ref_data["S"][18] * eps_factors["Sp"][22]
    sheet.cell(row=25,column=22).value = ref_data["S"][16] * eps_factors["Sp"][23]
    sheet.cell(row=26,column=22).value = ref_data["S"][2] * eps_factors["Sp"][24]

    #Tp
    sheet.cell(row=1,column=23).value = "Tp"
    sheet.cell(row=23,column=1).value = "Tp"
    for i in range(0,20):
        value_tmp = ref_data["T"][i] * eps_factors["Tp"][i]
        sheet.cell(row=i+2,column=23).value = value_tmp
        sheet.cell(row=23,column=i+2).value = value_tmp
    #Sp-Tp, Tp-Tp, Yp-Tp, acK-Tp, Rm-Tp
    sheet.cell(row=22,column=23).value = ref_data["T"][13] * eps_factors["Tp"][20]
    sheet.cell(row=23,column=23).value = ref_data["T"][7] * eps_factors["Tp"][21]
    sheet.cell(row=24,column=23).value = ref_data["T"][18] * eps_factors["Tp"][22]
    sheet.cell(row=25,column=23).value = ref_data["T"][16] * eps_factors["Tp"][23]
    sheet.cell(row=26,column=23).value = ref_data["T"][2] * eps_factors["Tp"][24]

    #Yp
    sheet.cell(row=1,column=24).value = "Yp"
    sheet.cell(row=24,column=1).value = "Yp"
    for i in range(0,20):
        value_tmp = ref_data["Y"][i] * eps_factors["Yp"][i]
        sheet.cell(row=i+2,column=24).value = value_tmp
        sheet.cell(row=24,column=i+2).value = value_tmp
    #Sp-Yp, Tp-Yp, Yp-Yp, acK-Yp, Rm-Yp
    sheet.cell(row=22,column=24).value = ref_data["Y"][13] * eps_factors["Yp"][20]
    sheet.cell(row=23,column=24).value = ref_data["Y"][7] * eps_factors["Yp"][21]
    sheet.cell(row=24,column=24).value = ref_data["Y"][18] * eps_factors["Yp"][22]
    sheet.cell(row=25,column=24).value = ref_data["Y"][16] * eps_factors["Yp"][23]
    sheet.cell(row=26,column=24).value = ref_data["Y"][2] * eps_factors["Yp"][24]
    #acK
    sheet.cell(row=1,column=25).value = "acK"
    sheet.cell(row=25,column=1).value = "acK"
    for i in range(0,20):
        value_tmp = ref_data["Q"][i] * eps_factors["acK"][i]
    ...
    sheet.cell(row=22,column=25).value = ref_data["Q"][13] * eps_factors["acK"][20]
    sheet.cell(row=23,column=25).value = ref_data["Q"][7] * eps_factors["acK"][21]
    sheet.cell(row=24,column=25).value = ref_data["Q"][18] * eps_factors["acK"][22]
    sheet.cell(row=25,column=25).value = ref_data["Q"][16] * eps_factors["acK"][23]
    sheet.cell(row=26,column=25).value = ref_data["Q"][2] * eps_factors["acK"][24]
    #Rm
    sheet.cell(row=1,column=26).value = "Rm"
    sheet.cell(row=26,column=1).value = "Rm"
    for i in range(0,20):
        value_tmp = ref_data["R"][i] * eps_factors["Rm"][i]
        sheet.cell(row=i+2,column=26).value = value_tmp
        sheet.cell(row=26,column=i+2).value = value_tmp
    #Sp-Rm, Tp-Rm, Yp-Rm, acK-Rm, Rm-Rm
    sheet.cell(row=22,column=26).value = ref_data["R"][13] * eps_factors["Rm"][20]
    sheet.cell(row=23,column=26).value = ref_data["R"][7] * eps_factors["Rm"][21]
    sheet.cell(row=24,column=26).value = ref_data["R"][18] * eps_factors["Rm"][22]
    sheet.cell(row=25,column=26).value = ref_data["R"][16] * eps_factors["Rm"][23]
    sheet.cell(row=26,column=26).value = ref_data["R"][2] * eps_factors["Rm"][24]
...
def add_mu(workbook,sheet_name="mu"):
    if sheet_name not in workbook.sheetnames:
        raise ValueError(f"Sheet '{sheet_name}' not found.")
    ...
    sheet.cell(row=22,column=1).value = "Sp"
    for i in range(0,25):
        sheet.cell(row=i+2,column=22).value = 2
        sheet.cell(row=22,column=i+2).value = 2
    #Tp
    sheet.cell(row=1,column=23).value = "Tp"
    sheet.cell(row=23,column=1).value = "Tp"
    for i in range(0,25):
        sheet.cell(row=i+2,column=23).value = 2
        sheet.cell(row=23,column=i+2).value = 2
    #Yp
    sheet.cell(row=1,column=24).value = "Yp"
    sheet.cell(row=24,column=1).value = "Yp"
    for i in range(0,25):
        sheet.cell(row=i+2,column=24).value = 2
        sheet.cell(row=24,column=i+2).value = 2
    #acK
    sheet.cell(row=1,column=25).value = "acK"
    sheet.cell(row=25,column=1).value = "acK"
    for i in range(0,25):
        sheet.cell(row=i+2,column=25).value = 2
        sheet.cell(row=25,column=i+2).value = 2
    #Rm
    sheet.cell(row=1,column=26).value = "Rm"
    sheet.cell(row=26,column=1).value = "Rm"
    for i in range(0,25):
        sheet.cell(row=i+2,column=26).value = 2
        sheet.cell(row=26,column=i+2).value = 2
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="For Mpipi like force fields.\n Patch your own ptm parameter according to the given Mpipi model parameter file.\n \
        The example of the input parameter filecould be seen as mpipi_parms.xlsx.\n \
        Please make sure the input file has the same format with mpipi_parms.xlsx."
    )
    parser.add_argument(
        "--input_path", 
        type=str,
        help="The input HPS force field parameter file. (xlsx format)")
    parser.add_argument(
        "--output_path",
        type=str,
        help="The patched ptm Mpipi force field parameter file."
    )
    parser.add_argument(
        "--factor_path",
        type=str,
    ...
    workbook = add_eps(workbook,eps_f)
    workbook = add_residues(workbook)
    workbook = add_s(workbook,s_f)
    workbook = add_mu(workbook)
